...
if __name__ == '__main__':
    ...
    parser.add_argument('--weights', type=str, default='./weights/material_7.pt', help='weights path')  # from yolov5/models/
    ...
    for k, m in model.named_modules():
        ...
        # darknet-------------------------------------------------------------------------------------------------------
        if isinstance(m, Darknet):
            for i, mm in enumerate(m.module_list):
                class_name = mm.__class__.__name__
                if class_name != 'FeatureConcat' and class_name != 'WeightedFeatureFusion'  \
                        and class_name != 'MaxPool2d' and class_name != 'Upsample' and class_name != 'YOLOLayer':
