...
Annota_Save_Root = '../../datasets/Material/cup_labels'   # label save
Image_Save_Root = '../../datasets/Material/cup_images'
Label_Root = '../../datasets/Material/data/2cup/xml'  # label name
Image_Root = '../../datasets/Material/data/2cup/img'
