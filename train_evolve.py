...
def train(hyp, opt, device, tb_writer=None):
    ...
    log_dir = Path(opt.logdir) / 'evolve'  # logging directory
    ...
    for epoch in range(start_epoch, epochs):
        ...
        for i, (imgs, targets, paths, _) in pbar:
            ...
            # Warmup -> lr from small to large -> just like you firstly draw a car into a unfamiliar city
            # while < mini batch, the step may far away from the right direction.
            ...
            # Autocast -> automated mixed precision -> haldfloat 16
            ...
            # Backward -> automated mixed precision, enlarge the gradient
